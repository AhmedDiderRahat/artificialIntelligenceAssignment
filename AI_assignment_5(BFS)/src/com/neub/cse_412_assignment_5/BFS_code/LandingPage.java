...
import com.neub.cse_412_assignment_5.developer_information.DeveloperOption;
...
public class LandingPage extends javax.swing.JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent button) {
        ...
        if (button.getSource() == finalOkjButton) {
            ...
            for (int i = 0; i < (no_of_edge * 2) - 1; i += 2) {
                info[i] = ( (model.getValueAt(rowNumber, 0)).toString() ).toLowerCase();
                info[i + 1] = (model.getValueAt(rowNumber, 1)).toString().toLowerCase();
                rowNumber++;
            }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Breath First Search");
